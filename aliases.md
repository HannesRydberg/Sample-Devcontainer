...
| `dev-up-debug` | `bash scripts/dev-up-debug.sh` | Runs `devcontainer up` with trace logs and prints the failing error lines. |
...
alias dev-up-debug='bash scripts/dev-up-debug.sh'
