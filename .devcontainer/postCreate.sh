...
echo "  mkdir -p ~/.config/dev"
echo "  cp .env.example ~/.config/dev/dev.env"
echo "  The devcontainer host bootstrap auto-creates the skill-folder paths; if it cannot run, create ~/.copilot/skills, ~/.agents/skills, and ~/.config/copilot-dev-skills manually"
